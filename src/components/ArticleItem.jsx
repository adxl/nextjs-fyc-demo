  ...
  return (
    <div className="flex flex-col max-w-sm p-6 border rounded-lg shadow bg-gray-800 border-gray-700">
      ...
      <div className="mt-auto">
        <Link to={`/articles/${article.id}`} className="inline-flex justify-center items-center px-3 py-2 text-sm font-medium text-center text-white hover:text-white rounded-lg focus:ring-4 focus:outline-none bg-blue-600 hover:bg-blue-700 focus:ring-blue-800">
          Read more
